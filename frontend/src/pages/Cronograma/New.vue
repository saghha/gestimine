    ...
    <ValidationObserver v-slot="{invalid}">
      <div class="row">
        <div class="col-12 text-right">
          <b-button variant="success" :disabled="invalid || info.valores.length == 0">Agregar item</b-button>
        </div>
        ...
        <div class="col-ld-4 col-md-4 col-sm-6">
          <ValidationProvider rules="required" v-slot="v">
            <div class="form-group">
              ...
              <b-form-input v-model="info.area"/>
            </div>
          </ValidationProvider>
        </div>
        <div class="col-ld-4 col-md-4 col-sm-6">
          <ValidationProvider rules="required" v-slot="v">
            <div class="form-group">
              <label :class="{'text-danger': v.failedRules.required}">% Ley</label>
              <b-form-input type="number" step=".01" max="1" min="0" v-model="info.ley"/>
            </div>
          </ValidationProvider>
        </div>
        <div class="col-ld-4 col-md-4 col-sm-6">
          <ValidationProvider rules="required" v-slot="v">
            <div class="form-group">
              <label :class="{'text-danger': v.failedRules.required}">Densidad</label>
              <b-form-input type="number" v-model="info.densidad"/>
            </div>
          </ValidationProvider>
        </div>
        <div class="col-ld-4 col-md-4 col-sm-6">
          <ValidationProvider rules="required" v-slot="v">
            <div class="form-group">
              ...
              <b-form-input type="number" v-model="info.metros_totales"/>
            </div>
          </ValidationProvider>
        </div>
      </div>
